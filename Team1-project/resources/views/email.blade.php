    ...
    <body>
        <div class="main">
            <div class="leftSection">
                ...
                <h1>Contact Us</h1>
                <p>Whether to ask a question or to give us feedback, feel free to contact us and we will be sure to handle
                    any concerns you may have. This will automatically send an email to hdc.retail@gmail.com, you can also
                    chose to email us directly.</p>
            </div>
            <form action="{{ route('send.email') }}" class="contact100-form validate-form" method="post"
                ...
                <div class="checkbox">
                    <input id="cb" type="checkbox" name="checkbox" required><span>I agree to the <a
                            href="{{ asset('/privacyNotice') }}">Privacy Policy for HDC</a></span>
                </div>
